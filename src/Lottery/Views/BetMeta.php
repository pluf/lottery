...
class Lottery_Views_BetMeta extends Pluf_Views
{
...
//     }
    ...
    public static function getMetaByKey($key, $betId)
    {
        ...
        $str = $sql->gen();
        $meta = Pluf::factory('Lottery_BetMeta')->getOne($str);
        return $meta;
    }
    ...
    public static function getByKey($request, $match)
    {
        ...
        if ($meta === null) {
            throw new Pluf_HTTP_Error404('Object not found (Lottery_BetMeta,' . $match['modelKey'] . ')');
        }
        return $meta;
    }
