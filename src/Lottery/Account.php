...
/**
 * Lottery Account data model
 *
 * Stores information of an lottery-account.
 */
class Lottery_Account extends Pluf_Model
{

    function init()
    {
        $this->_a['verbose'] = 'lottery-account';
    ...
    function preDelete()
    {
        ...
        Pluf_Signal::send('Lottery_Account::preDelete', 'Lottery_Account', $params);
    }
     ...
     *
     * @param string $login
     * @return Lottery_Account account information
     */
    public static function getAccount($login)
    {
        $model = new Lottery_Account();
